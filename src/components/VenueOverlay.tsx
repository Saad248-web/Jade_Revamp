...
const VenueOverlay: React.FC<VenueOverlayProps> = ({
  ...
  return createPortal(
    ...
    >
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-1 bg-[#0E3A2F] rounded-t-2xl md:rounded-t-[48px] shadow-[0_-20px_80px_rgba(0,0,0,0.6)] relative z-10">
          <div className="max-w-4xl mx-auto w-full pb-32">
            {/* IMAGE CAROUSEL */}
            <div className="relative aspect-[4/3] md:aspect-[16/9] w-full overflow-hidden bg-black/20 group rounded-t-[32px] md:rounded-t-[48px]">
      ...
      {/* PRICING BAR (ALIGNED WITH CONTENT) */}
