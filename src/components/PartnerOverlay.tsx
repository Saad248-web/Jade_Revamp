      ...
      {isPartnerOverlayOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed bottom-0 left-0 right-0 md:bottom-auto md:left-1/2 md:top-24 md:-translate-x-[55%] w-full md:w-[600px] bg-[#0E3A2F] z-[101] flex flex-col font-manrope rounded-t-2xl md:rounded-lg shadow-2xl border border-white/10 ${view === "success" ? "h-[80vh] md:h-[650px]" : "h-[90vh] md:h-auto md:max-h-[85vh]"}`}
          >
            {/* Minimal Header (Always visible for structure, but buttons hide/show) */}
            {view === "form" && (
              <div className="flex items-center justify-between px-6 pt-6 pb-2">
                <h2 className="text-white text-2xl font-philosopher">
                  Partner with us
                </h2>
                <div className="flex items-center gap-4 fixed top-6 right-6 md:absolute md:top-6 md:right-6">
                  {/* For mobile these buttons might need adjusting if they conflict with the viewport */}
                </div>
              </div>
            )}
                ...
                <div className="flex flex-col px-6 pb-8">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="mt-2 text-white">
                      <h3 className="text-white text-sm mb-3">Property Type</h3>
                      <div className="grid grid-cols-2 gap-y-3 gap-x-2">
                        {[
