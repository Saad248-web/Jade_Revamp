    ...
    <AnimatePresence>
      {isRathaaOverlayOpen && (
        <>
          ...
          {/* Modal Container */}
          <div
            className="fixed inset-0 z-[101] flex flex-col items-center justify-end pointer-events-none"
          ...
          >
            <motion.div
              ...
              className="relative w-full md:w-[600px] h-[calc(100vh-80px)] flex flex-col font-manrope pointer-events-auto mt-[80px]"
            >
              {/* Floating Close Button separated from the frame by 16px */}
              <button
                onClick={handleClose}
                className="absolute -top-[64px] left-1/2 -translate-x-1/2 z-[110] w-12 h-12 bg-[#0D4032] border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-[#EFCD62] hover:text-[#0D4032] transition-all duration-300 shadow-2xl"
              >
                <X className="w-5 h-5 stroke-[1.5]" />
              </button>

              {/* Content Box */}
              <div className="w-full h-full flex flex-col bg-[#123A2D] rounded-t-[32px] md:rounded-t-[40px] shadow-2xl border border-white/10 overflow-hidden">
                {/* CONTENT AREA */}
                <div
                  ...
                  {view === "form" ? (
                    ...
                    >
                      ...
                      <p className="text-white/80 text-gh-body mb-8">
                        Tell us your preferred dates, group size, and
                        destination. Our team will help you design a curated
                        caravan experience.
                      </p>
                      ...
                      <div className="mt-6">
                        <button
                          ...
                          className={`w-full py-4 font-manrope font-bold text-gh-label tracking-widest uppercase transition-all border ${
                            isFormValid()
                              ? "bg-[#1E5D48] hover:bg-white text-white/90 hover:text-black border-transparent"
