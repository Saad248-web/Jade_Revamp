  ...
  propertyDetails: [
    {
      ...
      description:
        "Spacious layout designed for group stays and shared living.",
      icon: "Bed",
    },
    {
      label: "Hill-facing Property",
      description: "Located along a ridge with open valley views.",
      icon: "Mountain",
    },
    {
      label: "Private Pool with Waterfall",
      description: "Pool with cascading waterfall and deck-side access.",
      icon: "Waves",
    },
    {
      label: "Lawn & Outdoor Zones",
      description: "Dedicated lawn space for gatherings and activities.",
      icon: "Trees",
    },
    {
      label: "Gazebo Seating Area",
      description: "Outdoor shaded sit-out for small groups.",
      icon: "Tent",
    },
    {
      label: "Indoor Lounge Space",
      description: "Common area designed for relaxation and entertainment.",
      icon: "Sofa",
    },
  ],
  services: [
  ...
  activities: [
    {
      ...
      description: "Live grill setups for group meals.",
      image:
        "/Villa_Retreats/Retreat on the ridge/Experiences/experiences_01.webp",
    },
    {
      title: "Bonfire Evenings",
      description: "Outdoor bonfire for gatherings.",
      image:
        "/Villa_Retreats/Retreat on the ridge/Experiences/experiences_02.webp",
    },
    {
      title: "Outdoor Dining Setups",
      description: "Dining across lawn and gazebo spaces.",
      image:
        "/Villa_Retreats/Retreat on the ridge/Experiences/experiences_03.webp",
    },
    {
      title: "Workation Stays",
      description: "Quiet environment suited for extended stays.",
      image:
        "/Villa_Retreats/Retreat on the ridge/Experiences/experiences_04.webp",
    },
    {
      title: "Board Games & Indoor Activities",
      description: "Group-friendly indoor engagement.",
      image:
        "/Villa_Retreats/Retreat on the ridge/Experiences/experiences_05.webp",
    },
  ],
  spaces: [
    {
      name: "Pool Deck",
      image: "/Villa_Retreats/Retreat on the ridge/Spaces/spaces_01.webp",
    },
    {
      name: "Ridge Terrace",
      image: "/Villa_Retreats/Retreat on the ridge/Spaces/spaces_02.webp",
    },
    {
      name: "Living Area",
      image: "/Villa_Retreats/Retreat on the ridge/Spaces/spaces_03.webp",
    },
    {
      name: "Hillside Suite",
      image: "/Villa_Retreats/Retreat on the ridge/Spaces/spaces_04.webp",
    },
  ],
  categorizedSpaces: [
    {
    ...
    },
    {
      ...
      images: ["/Villa_Retreats/Retreat on the ridge/Spaces/spaces_04.webp"],
    },
  ],
  pricing: {
    stay: {
  ...
  faq: [
    {
      ...
      answer: "Up to 12 guests can be accommodated.",
    },
    {
      question: "What is the event capacity?",
      answer: "Suitable for small gatherings up to 20 guests.",
    },
    {
