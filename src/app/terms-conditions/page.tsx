      ...
      <div className="max-w-4xl mx-auto px-6 py-32 border-x border-white/5 bg-[#0D4032]">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <ul className="space-y-4 text-gh-body text-white/70 leading-relaxed list-none">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-white font-bold text-gh-body mb-4 uppercase tracking-wider underline decoration-[#EFCD62] underline-offset-8">
          ...
          <footer className="pt-24 text-center border-t border-white/5">
            <h3 className="text-gh-h3 font-philosopher mb-4">Thank You!</h3>
