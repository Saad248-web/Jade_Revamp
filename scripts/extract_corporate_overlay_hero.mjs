/**
 * Renders card + hero + intro bands from Corporate_Villa_Overlay SVGs for visual transcription.
 * Output: .cursor/corporate-overlay-crops/{slug}-{card,hero,intro}.png
 */
import fs from "fs";
import path from "path";
import sharp from "sharp";

const ROOT = path.join(process.cwd(), "public", "Corporate_Villa_Overlay");
const OUT = path.join(process.cwd(), ".cursor", "corporate-overlay-crops");
const ZOOM = 1.85;
