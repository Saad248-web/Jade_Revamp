/**
 * optimize_emerald_images.js
 * Converts Emerald villa experience & perfect-for images to WebP.
 * - HEIC/HEIF → heic-convert → sharp → webp
 * - CR2/CR3   → binary JPEG extraction → sharp → webp
 * - JPG/JPEG/PNG → sharp → webp
...
const LOG_FILE =
  "C:\\Users\\Admin\\Desktop\\Jade_ReVamp\\emerald_optimization.log";
...
async function main() {
  log("=== Emerald Villa — Image Optimization ===");
  ...
  const ROOT =
    "C:\\Users\\Admin\\Desktop\\Jade_ReVamp\\public\\Villa_Retreats\\Emerald";
